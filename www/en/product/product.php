...
<div id="about_top">
<div id="about_toptitle">Product</div>
...
<div class="probox">
	<a href="/en/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo]?>">
    <img src="/upload/product/<?=getproductpic($arrprods[$i][id_prodinfo]);?>"  width="145"  height="125" />
    </a>
  <p><a href="/en/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo]?>"><?=$arrprods[$i][title];?></a></p>
</div>
<?php }?>
