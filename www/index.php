...
<?
$getlayoutpicnuminfo=getlayoutpicnuminfo(4,4,'title,intro,url');//取4张图片的信息标题 内容 URL
for($i=0;$i<sizeof($getlayoutpicnuminfo);$i++){//for循环4张图片
?>
<div class="newsinfo">
...
<?
$getlayoutpicnuminfo=getlayoutpicnuminfo(5,3,'title,intro,url,opicname as pic');//取4张图片的信息标题 内容 URL
for($i=0;$i<sizeof($getlayoutpicnuminfo);$i++){//for循环4张图片
?>
<div class="onepicbox">
