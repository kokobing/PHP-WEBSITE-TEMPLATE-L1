...
<div id="about_top">
<div id="about_toptitle">产品中心</div>
<div id="about_topintro">
<? if(isset($_GET[id1])){echo '所有产品';}?>
...
<li><a href="/product/product.php?id2=<?=$allproddir2[$i][id_proddir]?>" <? if($_GET[id2]==$allproddir2[$i][id_proddir]){echo 'class="curr"';}?>><?=$allproddir2[$i][name];?></a></li>
<? }?>
</ul>
</div>
...
<div class="probox">
	<a href="/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo]?>">
    <img src="/upload/product/<?=getproductpic($arrprods[$i][id_prodinfo]);?>"  width="145"  height="125" />
    </a>
  <p><a href="/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo]?>"><?=$arrprods[$i][title];?></a></p>
</div>
<?php }?>
